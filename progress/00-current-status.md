...
Expand fixtures and live Figma manual verification notes, then add bridge
persistence beyond the latest in-memory capture.

## Immediate Next Steps

1. Expand fixtures and manual verification notes for preserved instances, remote libraries, icons, and variable-heavy selections.
2. Add persistent storage and history support beyond the latest in-memory capture.
